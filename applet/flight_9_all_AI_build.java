import processing.core.*; import processing.opengl.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class flight_9_all_AI_build extends PApplet {
  ...
  public void upDate(){
    ...
    if(hp>=0){
      ...
      if(bAi){
        ...
        case 1:
          if(tPos[0]>skills[0]){
            controls[0]=.5f*limits[2]/s;
          }
          if(tPos[0]<-skills[0]){
            controls[0]=.5f*limits[3]/s;
          }
          if(!(tPos[0]>skills[0]||tPos[0]<-skills[0])){
            controls[0]=0; 
          }
          if(tPos[1]>skills[1]){
            controls[1]=.5f*limits[5]/s;
          }
          if(tPos[1]<-skills[1]){
            controls[1]=.5f*limits[4]/s;
          }
...
static public void main(String args[]) {   PApplet.main(new String[] { "flight_9_all_AI_build" });}}